...
function Section.new(tab, opts)
	...
	make("UIListLayout", {
		...
		FillDirection = Enum.FillDirection.Vertical,
		SortOrder = Enum.SortOrder.LayoutOrder,
		Padding = UDim_new(0, 0), -- no gaps between feature rows
	})
...
function Tab:Activate()
	...
	self._active = true
	if self._lbl then
		self._lbl.TextColor3 = Theme.Accent -- blue text on selected tab
	end
	if self._btn then
...
function Window.new(
	...
	make("UIListLayout", {
		Parent = tabList,
		FillDirection = Enum.FillDirection.Horizontal,
		Padding = UDim_new(0, 0), -- no gaps between tabs
		SortOrder = Enum.SortOrder.LayoutOrder,
		HorizontalAlignment = Enum.HorizontalAlignment.Left,
	...
	-- Translate vertical mouse-wheel into horizontal scrolling for the tab strip
